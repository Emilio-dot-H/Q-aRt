...
recieved. To do this we simply layed % typo; should be "laid"
...
\subsubsection{Main (Composed of Terminal, Input submodules) (M1)}
...
\midrule
AC1 & M1, M3\\ % this isn't rendered in the pdf?
AC2 & M2, M4, M5, M6, M7\\
UC1 & M2, M4, M5, M6, M7\\
UC2 & M4\\
\bottomrule
...
Main(//
Terminal (or experimental GUI) USES Input\\
...
modular heirarchy percolates at both ends into an Input, Terminal funnel at the top and Constants at 
the bottom, with all other modules on the same center level and all connected 
to each point of percolation.

% why is this figure commented out?
\begin{figure}[H]
\centering
