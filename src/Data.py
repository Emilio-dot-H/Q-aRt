...
def getDataBits(version, ecl, inputString):
    ...
    #   
	numPadBytes = int((requiredBits-len(data))/8)
...
def binString(data, length):
	data = str(bin(data))                           #converts decimal 'str1' into a string binary
	data = data[2:]                                 #removes the 2 leftmost characters '0b' generated by default
	while (len(data)<length):
		data = '0'+data                 #calls padBits function 
	return data
...
def numericEncoding(inputString):   
	...
	for i in strList:
		...
		if len(i) == 1: 
			...
			requiredLength = 7
		data = binString(int(i), requiredLength)
	return data
...
def byteEncoding(inputString):
	...
	for i in inputString:
		temp = ord(i.encode('iso-8859-1'))
		temp = binString(temp, 8)
		data += temp
	return data
